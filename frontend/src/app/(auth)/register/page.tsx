  ...
  return (
    <div className="login-card glass-card">
      <div className="login-header">
        <div className="logo-vertical">
          ...
          <div className="logo-text-vertical">
            ...
            <span className="logo-subtitle">GALÁXIAS</span>
          </div>
        </div>
        <p className="login-greeting">Crie sua conta e comece sua jornada 🚀</p>
      </div>

      <div className="oauth-providers">
        <button className="btn btn-secondary w-full provider-btn">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: '8px' }}>
      ...
      <div className="divider">
        <span>ou crie usando seu e-mail</span>
      </div>
      ...
      <div className="login-footer">
        <p>Já possui uma conta? <Link href="/login">Fazer Login</Link></p>
      </div>
    </div>
  );
}
